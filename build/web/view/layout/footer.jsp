<%-- 
    Document   : footer
    Created on : Mar 3, 2025, 9:56:43 PM
    Author     : HP
--%>
            ...
            <div class=" col-xl-3 col-lg-4 col-sm-6">
                <div class="single-footer pb--40">
                    <div class="brand-footer footer-title">
                        <img src="${pageContext.request.contextPath}/image/logo--footer.png" alt="">
                    </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <a href="#" class="payment-block">
                <img src="${pageContext.request.contextPath}/image/icon/payment.png" alt="">
            </a>

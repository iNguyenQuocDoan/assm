...
public class ProductDAO extends DBContext {
    ...
    public void deleteById(Product product) {
        ...
        for (Product account : new ProductDAO().findAll()) {
            System.out.println(account);
        }
//println(new ProductDAO().findByUsernamePassword("doan", "1"));
//        System.out.println(new ProductDAO().findByUsernamePassword("doan", "1"));
    }
}
